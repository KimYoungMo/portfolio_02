										...
										<div class="panel-body">
											<div class="examples list-group">
												<c:if test="${ sessionScope.typeSeq == 9}" >
													<a href='/s06/notice/nlist.do' class="list-group-item" target="demoFrame"> 공지사항 </a>
												</c:if>
												<a href='/s06/board/list.do' class="list-group-item" target="demoFrame"> 자유게시판 </a>
											</div>
										</div>
									</div>
								</div>
										...
										<div class="panel-body">
											<div class="examples list-group">
												<a href='/test.do' class="list-group-item" target="demoFrame">
													메뉴2-1 </a> <a href='/test.do' class="list-group-item"
													target="demoFrame"> 메뉴2-2 </a> <a href='/test.do'
													class="list-group-item" target="demoFrame"> 메뉴2-3 </a> <a
													href='/test.do' class="list-group-item" target="demoFrame">
													메뉴2-4 </a>
											</div>
										</div>
									</div>
